...
function getStoryItem(post) {
        ...
        <article>
            <header>
                <div class="profile-of-article">
                    <a href="/user/profile?profileEmail=${post.postUploader.email}"><img class="img-profile pic" src="/image/${post.postUploader.profileImgFile?.storeFileName}" onerror="this.src='/img/default_profile.jpg'""></a>
                    <span class="userID main-id point-span" >${post.postUploader.name}</span>
                </div>
            </header>
            <div class="main-image">
                <img src="/image/${post.postImgUrl}" class="mainPic">
            </div>
    ...
    item += `
                ...
                <div class="subscribe__img">
                    <span>${post.dateTime.toLocaleString()}</span>
                </div>
